...
export const ROUTE_ROOM = 'room' as const;
export const ROUTE_CHARACTER = 'character' as const;
...
export const MAN_AVATAR_URL = '/models/roomMan.glb' as const;
export const WOMAN_AVATAR_URL = '/models/roomWoman.glb' as const;
